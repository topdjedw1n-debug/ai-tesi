...
3. **Understand decisions:** [AGENT_SYNC.md](./AGENT_SYNC.md)
...
2. Search in [AGENT_SYNC.md](./AGENT_SYNC.md) (history: [archive/DECISIONS_LOG.md](./archive/DECISIONS_LOG.md)) for reasoning.
...
**Production readiness:** see [AGENT_SYNC.md](./AGENT_SYNC.md) (go/no-go status and rule in §5) and [setup/PRODUCTION_DEPLOYMENT_PLAN.md](./setup/PRODUCTION_DEPLOYMENT_PLAN.md).
