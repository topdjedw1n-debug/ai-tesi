...
**Лишилось до RUN-001:** ПОПОВНИТИ OPENAI-КВОТУ (блокер gpt-4-шляху) +
рішення про модель-писаря (див. doc 10) + рішення C-блоку (пороги,
Compilatio-процес, відповідальні).
