...
Дата: 08.09.2026. Статус: **LOCAL_BEHAVIOR_VERIFIED / S4_INSTALLED_CONTROL_PENDING**.
...
| S4/S5 | S4: реліз встановлено й технічно перевірено; контроль №9 чекає окремого погодження. S5 відкритий |
| Новий production-реліз/генерація/Compilatio | Реліз189aba7 встановлено; нова генерація та Compilatio не виконувалися |
