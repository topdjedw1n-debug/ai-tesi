...
export default function SnakeGame() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-green-50 to-primary-50 p-4">
      <div className="bg-white rounded-lg shadow-2xl p-6 max-w-2xl w-full">
        ...
        {!gameStarted && (
          <div className="text-center mt-6 p-6 bg-primary-50 rounded-lg">
