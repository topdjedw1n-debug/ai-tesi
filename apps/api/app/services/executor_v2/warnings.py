...
WARNING_CODES = {
    ...
    "section_without_documents": (
        "warning",
        "Розділ написано без повнотекстових документів за його темою; завантажте PDF або прийміть прогалину.",
    ),
    ...
    "page_out_of_range": (
        "warning",
        "Частина посилань вказує сторінку поза межами документа; перевірте локатори перед видачею.",
    ),
    "quote_without_page": (
        "info",
